...
<body id="top">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="search.html">Search (Grid View)</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="blog.html">Blog Archive</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="#modal-signin" class="signin" data-toggle="modal" data-target="#modal-signin">Sign in</a>
                    </li>
                    <li><a href="#" class="signup" data-toggle="modal" data-target="#modal-signup">Sign up</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <!-- Javascript Libraries (Load last to increase page speed) -->
